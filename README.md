...
[tar.gz](https://github.com/opis/closure/archive/2.3.2.tar.gz) or the [zip](https://github.com/opis/closure/archive/2.3.2.zip)
archive file, extract the content of the archive and include de `autoload.php` file into your project. 

```php

require_once 'path/to/closure-2.3.2/autoload.php';
