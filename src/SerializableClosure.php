...
class SerializableClosure implements Serializable
{
    ...
    /**
     * @var string|null Closure scope
     */
    protected $scope;

    /**
     * @var ClosureContext|null Context of closure, used in serialization
     */
    ...
    public function __construct(Closure $closure)
    {
        ...
        if (static::$context instanceof ClosureContext) {
    ...
    public function serialize()
    {
        ...
        if (static::$securityProvider instanceof ISecurityProvider) {
            $data = static::$securityProvider->sign($serialized);
            $serialized = \sprintf('@%s.%s', $data['hash'], $data['closure']);
        }
    ...
    {
        if (static::$context instanceof ClosureContext && !--static::$context->locks) {
            static::$context = null;
        }
    }
